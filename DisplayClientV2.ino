...
#define DEVICE_UNIQUE_ID "c5927bad-6573-4d8b-befd-221e355d2689" //{"UniqueId":"c5927bad-6573-4d8b-befd-221e355d2689","Name":"DEVICE_UNIQUE_ID","Type":"uniqueid"}
...
void loop() {
    ...
    Serial.write(" Data  get\r\n");
		if (FlowSerialTimedRead() == MESSAGE_HEADER)
		{
      Serial.write("get Header!\r\n");
